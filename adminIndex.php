           ...
           <?php 
             ...
             $count = 1;
              foreach($rows as $rows){
                ...
                echo "<td class=''>".htmlentities($rows['name'])."</td>";
                echo "<td class='' >".htmlentities($rows['donations'])." </td>";
                echo("<td class='' > <a class='btn btn-primary btn-sm' href='admin/delete.php?donor_id=".$rows['donor_id']."'>Remove Donor</a></td>");
                echo "</tr>";
              $count++;
              }
            ?>
